...
public class AddQuest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int no = qdi.addQuest(question, Integer.parseInt(eid));
		

			sess.setAttribute("amsg", "Question "+ no+" added successfully");
			
			System.out.println(no);
			
		}
		else {
			sess.setAttribute("famsg","There is an error occured....");
			
		}
		sess.setAttribute("id", eid);
		response.sendRedirect("admin/AddQuest.jsp");	
		}
	}

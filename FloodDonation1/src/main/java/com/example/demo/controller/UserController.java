...
import com.example.demo.FloodDonation1Application;
import com.example.demo.MyOrder;
import com.example.demo.dao.MyOrderRepo;
import com.example.demo.impl.EmailSenderService;
import com.example.demo.impl.EmailServiceImpl;
...
public class UserController {
	...
	private final EmailSenderService emailss;
	
	public UserController(EmailSenderService ess) {
		this.emailss = ess;
	}
...
//		creating new order
	...
	public ResponseEntity<?> updateOrder(@RequestBody Map<String, Object> data){
		...
		String msg = "Thank you " +name+ " for showing kindness toward Flood Affected people. Your transaction is successful.\n Thank you once again.";
		System.out.println(data);
		
		this.emailss.sendEmail(data.get("email")+"", "Flood Donation", msg);
